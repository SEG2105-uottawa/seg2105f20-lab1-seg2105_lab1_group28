...
public class Design3Test {
	...
	public static void main(String[] args) {
		...
		long[][] totalResults = new long [10000][8];
		for(int i=0;i<50;i++) {
			PointCP3 testPoint;
			testPoint = new PointCP3('P',Math.random()*9.0, Math.random()*9.0);
			long[] result = performanceTest(testPoint);
			totalResults[i] = result;
		}
		for(int j=50;j<100;j++) {
			PointCP3 testPoint;
			testPoint = new PointCP3('C',Math.random()*9.0, Math.random()*9.0);
			long[] result = performanceTest(testPoint);
	...
	private static long[] performanceTest(PointCP3 point) {
	...
	private static long testGetX (PointCP3 point) {
		  long start = System.currentTimeMillis();
	...
	private static long testGetY (PointCP3 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
			  point.getY();
		  }
	...
	private static long testGetRho (PointCP3 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
			  point.getRho();
		  }
	...
	private static long testGetTheta (PointCP3 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
			  point.getTheta();
		  }
	...
	private static long testConvertStorageToPolar (PointCP3 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
	...
	private static long testConvertStorageToCartesian (PointCP3 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
	...
	private static long testGetDistance (PointCP3 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
	...
	private static long testRotatePoint (PointCP3 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
