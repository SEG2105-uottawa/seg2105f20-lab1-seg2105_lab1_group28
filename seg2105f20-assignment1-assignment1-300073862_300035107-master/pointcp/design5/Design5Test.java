...
public class Design5Test {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<50;i++) {
			PointCP5 testPoint;
			testPoint = new PointCP2('P',Math.random()*9.0, Math.random()*9.0);
	...
	private static long[] performanceTest(PointCP5 point) {
	...
	private static long testGetX (PointCP5 point) {
		  long start = System.currentTimeMillis();
	...
	private static long testGetY (PointCP5 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
			  point.getY();
		  }
	...
	private static long testGetRho (PointCP5 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
			  point.getRho();
		  }
	...
	private static long testGetTheta (PointCP5 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
			  point.getTheta();
		  }
	...
	private static long testConvertStorageToPolar (PointCP5 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
	...
	private static long testConvertStorageToCartesian (PointCP5 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
	...
	private static long testGetDistance (PointCP5 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
	...
	private static long testRotatePoint (PointCP5 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
