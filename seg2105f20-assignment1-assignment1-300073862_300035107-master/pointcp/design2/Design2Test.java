...
public class Design2Test {
	...
	public static void main(String[] args) {
		...
		for(int j=50;j<100;j++) {
			PointCP2 testPoint;
			testPoint = new PointCP2('C',Math.random()*9.0, Math.random()*9.0);
			long[] result = performanceTest(testPoint);
	...
	private static long[] performanceTest(PointCP2 point) {
	...
	private static long testGetX (PointCP2 point) {
		  long start = System.currentTimeMillis();
	...
	private static long testGetY (PointCP2 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
			  point.getY();
		  }
	...
	private static long testGetRho (PointCP2 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
			  point.getRho();
		  }
	...
	private static long testGetTheta (PointCP2 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
			  point.getTheta();
		  }
	...
	private static long testConvertStorageToPolar (PointCP2 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
	...
	private static long testConvertStorageToCartesian (PointCP2 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
	...
	private static long testGetDistance (PointCP2 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
	...
	private static long testRotatePoint (PointCP2 point) {
		  long start = System.currentTimeMillis();
		  for(int i=0; i<300000; i++) {
